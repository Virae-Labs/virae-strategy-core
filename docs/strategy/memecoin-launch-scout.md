...
Missing honeypot, Top-10 holder, developer-holder, or quote evidence fails closed. A new pool can return `WAIT`; a pool older than the launch window is permanently skipped for that observation.
