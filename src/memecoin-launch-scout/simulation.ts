...
export function buildMemecoinLaunchScoutSystemSimulationMatrix(): MemecoinLaunchSimulationScenario[] {
  ...
  return [
    ...
    entry('holder-data-unavailable', 'DATA_QUALITY', 'Missing holder evidence passes through to the remaining entry gates.', (i) => { i.observation.top10HolderPct = null; i.observation.devHolderPct = null; }, 'ELIGIBLE', 'ENTRY_READY'),
