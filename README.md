...
| --- | --- | --- | --- |
| [Crypto Tail](./docs/strategy/crypto-tail.md) | BTC/ETH/SOL/DOGE/XRP/BNB Up/Down (15m and 1h) | `WAIT` / `SKIP` / `ELIGIBLE`, entry plan, chase, exit, lifecycle commands | Time-and-distance signal, TWAP/spot consistency, spread/depth/risk gates, bounded lifecycle |
...
```bash
npm install --save-exact @viraeai/virae-strategy-core@0.10.1
```
